...
public class AccountBaseTests
{
    ...
    [Fact]
    public void AccountBase_Deposit_NegativeAmount_BalanceShouldBeZero()
    {
        //arrange
        var account = new BankAccount("test", "123", 0);
    ...
    {
        var acccount = new BankAccount("test", "123", startingBalance);

        acccount.Deposit(deposit);

        Assert.Equal(expected, acccount.Balance());
    ...
    public void Account_Withdraw_ToEmptyBalanceSHpuldBeZero(decimal startingBalance, decimal withdrawAmount, decimal expected)
    {
        var account = new BankAccount("test", "test", startingBalance);
    ...
    [Fact]
    public void AccoiuntBase_Balance_ResultShouldBe500()
    {
    ...
    [Fact]
    public void AccoiuntBase_Balance_ResultBeZero()
    {
